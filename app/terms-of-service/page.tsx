...
import { Prose } from "@/components/blog/chrome";
  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-3xl px-5 py-14 sm:py-20">
        <span className="text-xs font-bold uppercase tracking-[0.18em] text-accent">[ Legal ]</span>
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">Terms of Service</h1>
        <p className="mt-4 text-sm text-neutral-500">Effective date: {EFFECTIVE} · Last updated: {EFFECTIVE}</p>

        <Prose>
          <p>
            These Terms of Service (the <strong>&ldquo;Terms&rdquo;</strong>) form a legally binding agreement between
            you (<strong>&ldquo;you&rdquo;</strong>, <strong>&ldquo;your&rdquo;</strong>) and {COMPANY}
            (<strong>&ldquo;{brand.name}&rdquo;</strong>, <strong>&ldquo;we&rdquo;</strong>,{" "}
            <strong>&ldquo;us&rdquo;</strong>, <strong>&ldquo;our&rdquo;</strong>), a limited liability company formed
            in November 2025 under the laws of the State of Wyoming, United States, with its registered address at{" "}
            {ADDRESS}. They govern your access to and use of the {brand.name} website, applications, and related services
            (together, the <strong>&ldquo;Service&rdquo;</strong>).
          </p>
          <p>
            By creating an account, accessing, or using the Service in any way, you confirm that you have read,
            understood, and agree to be bound by these Terms and by our Privacy Policy. <strong>If you do not agree, you
            must not access or use the Service.</strong>
          </p>
          ...
          <h2>2. Not financial advice &mdash; risk disclosure</h2>
          <p>
            <strong>{brand.name} is not a financial advisor, investment adviser, broker, broker-dealer, or fiduciary, and
            nothing in the Service constitutes financial, investment, trading, legal, tax, or accounting advice.</strong>{" "}
          ...
          <p>
            ...
            account. Notify us immediately at {EMAIL} of any unauthorized use. We may refuse, suspend, or terminate
            accounts at our discretion, including for any breach of these Terms.
          </p>

          <h2>5. Subscriptions, billing, and price changes</h2>
          <p>
          ...
          <h2>10. Third-party data and services</h2>
          <p>
          ...
          <h2>15. Changes to the Terms and the Service</h2>
          <p>
